...
const Autocomplete = ({ label, value, onChange, options = [] }) => {
  ...
  const handleInputChange = (e) => {
    ...
    // Normalize input for diacritic-insensitive search
    const normalizedInput = removeDiacritics(input);

    const matches = options.filter((option) => {
      // Normalize station name for comparison
      const normalizedStationName = removeDiacritics(option.stationName);
      return normalizedStationName.includes(normalizedInput);
    });
...
//     const matches = options.filter((option) => {
//       // Normalize station name and location for comparison
//       const normalizedStationName = removeDiacritics(option.stationName);
//       const normalizedLocation = removeDiacritics(option.location || "");
//       return (
//         normalizedStationName.includes(normalizedInput) ||
...
//               onMouseLeave={(e) => (e.target.style.backgroundColor = "white")}
//             >
//               {option.stationName} ({option.location})
//             </li>
//           ))}
//         </ul>
//       )}
